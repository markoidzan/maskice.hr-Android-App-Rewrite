...
/**
 * Created by Marko on 11.12.2017..
 */

public class Memorija extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        webStranica.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if ((url.startsWith("http:") || url.startsWith("https:")) && Uri.parse(url).getHost().contains("maskice.hr") || Uri.parse(url).getHost().contains("tawk.to")) {
                    return false;
        ...
        webStranica.loadUrl("https://maskice.hr/kategorija-proizvoda/oprema-za-mobitele/");
